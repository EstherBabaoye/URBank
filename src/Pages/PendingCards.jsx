  ...
  const handleAction = async (id, action) => {
    ...
    try {
      const res = await axios.post(
        `https://urbankbe.nhsurulere.site/api/admin/cards/${id}/${action}`,
        {},
        { withCredentials: true }
      );
  ...
  return (
    <div className="p-4 sm:p-8 mt-24">
      ...
      {loading ? (
        ...
        <p className="text-center text-gray-500">No pending card applications.</p>
      ) : (
                ...
                >
                  ...
                  <td className="p-2 sm:p-3 border">
                    <div className="flex flex-col sm:flex-row gap-2 sm:space-x-2">
                      ...
                      >
                        {loadingIds.includes(card.id) ? "Processing..." : "Approve"}
                      </button>
                      ...
                      >
                        {loadingIds.includes(card.id) ? "Processing..." : "Reject"}
                      </button>
                    </div>
                  </td>
                </tr>
