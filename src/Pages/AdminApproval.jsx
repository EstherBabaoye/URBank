          ...
          <table className="w-full min-w-[600px] border border-gray-300 rounded-lg">
            ...
            <tbody>
              {accounts.map((acc) => {
                ...
                return (
                  <tr key={acc.id} className="text-xs sm:text-sm border-t even:bg-gray-50">
                    <td className="p-2 sm:p-3 border">{acc.first_name} {acc.surname}</td>
                    <td className="p-2 sm:p-3 border break-words">{acc.email}</td>
                      ...
                      <div className="flex flex-col gap-2 md:flex-row md:items-center md:gap-3">
                        ...
                        <div className="flex gap-2 flex-col sm:flex-row">
                          <input
                            ...
                            onChange={(e) =>
                              setReasons({ ...reasons, [acc.id]: e.target.value })
                            }
