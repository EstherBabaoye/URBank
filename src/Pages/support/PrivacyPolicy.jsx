      ...
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 space-y-6">
        ...
        <Section title="11. Remedies & Complaints">
          <p className="text-sm">
            ...
            <br />
            📧 <a href="mailto:urbank.complaints@urbank.com" className="text-[#051d40] underline">firstcontact.complaints@firstbankgroup.com</a><br />
            📧 <a href="mailto:dataprotectionoffice@urbank.com" className="text-[#051d40] underline">dataprotectionoffice@firstbankgroup.com</a><br />
            ☎️ 0700-12345678
            <br />
