...
export default function ContactUs() {
  ...
  const handleSubmit = (e) => {
    fetch("https://urbankbe.nhsurulere.site/api/contact", {
      method: "POST",
      headers: {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        >
          ...
          <ContactInfoItem
            Icon={EnvelopeIcon}
            title="Email"
            content="support@urbank.ng"
            subtext="We reply within 24 hours."
          />
          <ContactInfoItem
            Icon={MapPinIcon}
            title="Office"
            content="URBank Headquarters, 123 Banking Ave, Lagos, Nigeria"
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-full shadow-lg transition"
          >
            Send Message
          </button>
        </motion.form>
